...
const packages = {
  'darwin-arm64': {
    packageName: '@landstrip-runtime/landstrip-darwin-arm64',
    binary: 'bin/landstrip',
  },
  'darwin-x64': {
    packageName: '@landstrip-runtime/landstrip-darwin-x64',
    binary: 'bin/landstrip',
  },
  'linux-x64': {
    packageName: '@landstrip-runtime/landstrip-linux-x64',
    binary: 'bin/landstrip',
  },
  'win32-x64': {
    packageName: '@landstrip-runtime/landstrip-win32-x64',
  ...
  try {
    ...
    throw new Error(
      `The landstrip binary package ${value.packageName} is not installed. ` +
        'Reinstall @landstrip-runtime/landstrip with optional dependencies enabled.'
    );
  }
